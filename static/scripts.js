...
function addMarker(place)
{
    ...
    // get news articles and display them in list
    $.getJSON("articles", {
        geo: place.postal_code
        },  function(news) {
                let ulist = "<ul>";
                for (i = 0; i < news.length; i++) {
                    ulist += "<li><a href="+ news[i].link + " target='blank'>" + news[i].title + "</a></li>";
                }
                // end list
                ulist += "</ul>";

                // listen for clicks and show articles in case of event
